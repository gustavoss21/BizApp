...
class Cliente
{
    ...
    public function get_clients()
    {
        ...
        $cliente = $conection->EXE_QUERY($query, $queryParameters);

        return self::responseSuccess($cliente, 'client ok');
    }
    ...
    public function update_client()
    {
        ...
        return self::responseSuccess($result, 'update success');
    }
    ...
    public function destroy_client()
    {
        ...
        return self::responseSuccess($result, 'remove success');
    }
}
